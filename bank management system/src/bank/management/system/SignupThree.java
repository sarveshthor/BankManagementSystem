...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        services.setBounds(100 , 450, 240 ,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            String sacctype = null; //r1 - savings account, r2 - Fixed Deposit Account, r3 - Current Account
            if(r1.isSelected()){// r4 - Recurring Deposit Account
            sacctype = "Savings Account";
            ...
            if(c1.isSelected()){
                ...
                Conn c = new Conn();
                String query1 = "insert into signupthree values('"+formno+"' , '"+sacctype+"' , '"+cardnumber+"' ,"
                        + " '"+pinnumber+"' , '"+facility+"')";
